...
help() {
  ...
  echo -e "\n\e[1;37mOptions (\e[1;33mupdate\e[0m\e[1;37m only):"
  echo -e "  \e[1;34m-f\e[0m, \e[1;34m--full\e[0m      Perform full system \e[1;33mupdate\e[0m"
  echo -e "  \e[1;34m-g\e[0m, \e[1;34m--go\e[0m        Update the Go toolchain only"
  echo -e "  \e[1;34m-r\e[0m, \e[1;34m--rust\e[0m      Update the Rust toolchain and Cargo packages only"
  echo -e "  \e[1;34m-s\e[0m, \e[1;34m--system\e[0m    Update the operating system only"
  echo -e "  \e[1;34m-u\e[0m, \e[1;34m--universal\e[0m Update universal packages (Flatpaks, Snaps, etc.) only"
  echo -e "\n\e[1;37mArguments:"
